...
fn create_auction_item(
    ...
    // @TODO Make changes in frontend for giving AUCTIONID while inputing.
    let auctionID = input.auctionID;
    ...
    AUCTION_MAP.insert(deps.storage, &auctionID, &auction_item)?;
...
pub fn create_bid(
    ...
    // @TODO
    // if amount input.amount < basePrice {
    // return Err(StdError::generic_err("Amount of bidding is less than the base price"))
    // };
    ...
    // @TODO iske niche ka shayad use nahi aayega since ye SECRETPATH ko use karte wakt liya tha
    // SecretJS se related dekh kaise kaam chalega
...
fn retrieve_bids_query(env: Env, deps: Deps, key: u32) -> BidResult {
    ...
    if env.block.height > max_block_height {
        ...
        // @TODO
        // Axelar use karke, sol k contract ko call karke , waha bidder's address ko NFT bhej denge
        // Baaki bidders ko paise return , aur owner of NFT ko bid.amount bhej denge
